...
type MovieForm = {
  ...
  language: string;
  rating: string;
  status: ApiMovie["status"] | string;
};

type AdminMoviesSectionProps = {
  movies: ApiMovie[];
  movieForm: MovieForm;
  setMovieForm: (form: MovieForm) => void;
  handleSubmitMovie: (event: FormEvent) => void;
  editMovie: (movie: ApiMovie) => void;
  deleteMovie: (movieId: number) => Promise<void>;
};

const AdminMoviesSection: React.FC<AdminMoviesSectionProps> = ({
  movies,
  movieForm,
  setMovieForm,
  handleSubmitMovie,
    ...
    <div className="admin-workspace">
      <form className="form-panel admin-form" onSubmit={handleSubmitMovie}>
        ...
        <input
          ...
          onChange={(e) =>
            setMovieForm({ ...movieForm, release_date: e.target.value })
          }
        />
        ...
        <input
          ...
          onChange={(e) =>
            setMovieForm({ ...movieForm, trailer_url: e.target.value })
          }
        />
...
export default AdminMoviesSection;
